...
export default function Shimmer() {
  ...
  <div className="w-3 h-3 rounded-full bg-[var(--color-text)] dot"></div>
          ...
          {['Feels Like' , 'Humidity' , 'Wind Speed' , 'Precipitation'].map((e, i) => {
            return (
              <div
                key={i}
                    ...
                    <div>
                        ...
                        <div className='grid sm:grid-cols-7 xs:grid-cols-4 grid-cols-3 gap-2 '>
                            { new Array(7).fill(0).map((_, i) => {
                                return <div className='bg-[var(--color-neutral-800)] flex flex-col items-center rounded-xl h-[165px] gap-1.5 border-1 border-[var(--color-neutral-600)]' key={i}>
